...
// aos 
import 'aos/dist/aos.css'; // You need AOS's styles to be loaded in your app
...
.mobile-break {
    ...
    @media screen and (min-width: 0px) and (max-width: 768px) {  // Adjust the breakpoint as needed
