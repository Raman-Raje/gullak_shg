...
import shgsettingValidation from '@validation/shg/shgsettingValidation';

// supabase
import supabase from '@client/client';


const GroupSettingForm = ({ initialValues, group_id }) => {
    ...
    return (
        <Formik
            ...
            validationSchema={shgsettingValidation}
            onSubmit={onSubmit}
        >
