...
const ShapeButton = ({ hasNotification, icon, handler, label, shape, width, ...props }) => {
  return (
    <Button className={shape} onClick={handler} aria-label={label} ref={props.ref} width={width} {...props}>
